...
export class ApplicationTemplateComponent implements OnInit {
                  ...
                  "data": [
                    {
                      "value": "未启用",
                      "icon": "fa fa-cog",
                      "className": "label alert-success",
                      "valueas": "禁用"
                    },
                    {
                      "value": "已启用",
                      "icon": "fa fa-cogs",
                      "className": "label alert-warning",
                      "valueas": "启用"
                    }
                  ]
                }
    ...
    "ApiDoc": [
      [
          ...
          "viewCfg": {
             ...
             /* {
              ...
              },*/
              {
                ...
                "nodeTypes": [
                  {
                    "classType": "SFDW_Classes.TDynaTreeNodeConfig",
                    "entityClass": "SinoForce.ApiDoc.ApiDoc/null/SinoForce.ApiDoc.ApiDoc",
                    "img": "fa fa-list green",
                    "textKey": "Name",
                    "idKey": "Id",
                    "parameters": [
                    ...
                    "localCreate": false,
                    "readOnly": false,
                    "columnConfigsClass": "SinoForce.ApiDoc.ApiDoc/null/SinoForce.ApiDoc.ApiDoc",
                    "enabled": true
                  }
                ],
                "textKey": "Name",
            ...
            "childConfigList": [
              ...
              },*/
              {
                ...
                "localCreate": false,
                "readOnly": false,
                "columnConfigsClass": "SinoForce.ApiDoc.ApiDoc",
                "enabled": true,
                "textKey": "Name",
                "idKey": "Id",
                "nodeTypes": [
                  {
                    ...
                    "filters": [
                      {
                        "classType": "SFDW_Classes.TEntityLink",
                        "masterClass": "SinoForce.ApiDoc.ApiDoc",
                        "slaveClass": "SinoForce.ApiDoc.ApiDoc",
                        "propLinks": [
                          {
                            "classType": "SFDW_Classes.TPropertyLink",
                            "masterProp": "Id",
                    ...
                    "entityClass": "SinoForce.ApiDoc.ApiDoc",
                    "parameters": [
                      "PlatCustomerId=f2771e4c90db29439e3c986d9859dc74",
                      "ProjId=0ac12f70c2a7a44794b57ef0c1c480c2"
                    ],
              ...
              {
                "classType": "SFDW_Classes.SFDW_Classes.TTreeNodeChildrenConfig",
                "img": "fa fa-list green",
                "filters": [
                  {
                    "classType": "SFDW_Classes.TEntityLink",
        ...
        },
        {
          ...
          "viewCfg": {
            "viewId": "textInfo_1",
            "parentViewId": "areaTree_api",
            "component": "text_info",
            "textInfoCfg" : {
              "noteType": "note-default",
              "infoTitle": {
                "name":"Name",
                "value": "用户手册"
              },
          ...
          "viewCfg": {
            ...
            "rootConfigs": [
               ...
               },*/
              {
                ...
                "textKey": "Name",
                "idKey": "Id",
                "entityClass": "SinoForce.Resource.DynamicResModule",
                "localCreate": false,
                "readOnly": false,
                "columnConfigsClass": "SinoForce.Resource.DynamicResModule",
                "enabled": true
              }
            ],
            "childConfigList": [
              {
                ...
                "localCreate": false,
                "readOnly": false,
                "columnConfigsClass": "SinoForce.Resource.ResourceType",
                "enabled": true,
                "textKey": "Name",
                "idKey": "Id",
                "nodeTypes": [
                  {
                    ...
                    "filters": [
                      {
                        "classType": "SFDW_Classes.TEntityLink",
                        "masterClass": "SinoForce.Resource.DynamicResModule",
                        "slaveClass": "SinoForce.Resource.ResourceType",
                        "propLinks": [
                          {
                            "classType": "SFDW_Classes.TPropertyLink",
                            "masterProp": "Id",
                    ...
                    "entityClass": "SinoForce.Resource.ResourceType",
                    "parameters": [
                      "_select=Id+as+Key%2C+OwnerNameSpace%2B%22.%22%2BName+as+Value",
                    ],
                    "localCreate": false,
                    "readOnly": false,
                    "columnConfigsClass": "SinoForce.Resource.ResourceType",
  ...
  constructor(private router: ActivatedRoute, private clientStorage: ClientStorageService) {
    ...
    this.router.params.subscribe(param => {
      this._config = this.configs[param.name];
    });
  }
